...
app.controller("gpaCtrl", function ($scope) {
    ...
    function findEligibility(gpa) {
        let greetingsText = "Salom",
            eligibilityText = "Dunyo",
            style = "green-text";

        if (gpa >= 3.7) {
            style = "green-text";
            greetingsText = "Brilliant!";
            eligibilityText = 'Siz "Birinchi sinf" darajasini saqlayapsiz. Shunday davom eting!';
        } else if (gpa >= 3.3) {
            style = "teal-text";
            greetingsText = "Juda yaxshi!";
            eligibilityText =
                'Hozirda siz "Ikkinchi yuqori" darajasidasiz. "Birinchi sinf" ga borish uchun biroz koproq harakat qiling.';
        } else if (gpa >= 3.0) {
            style = "blue-text";
            greetingsText = "Yaxshi!";
            eligibilityText =
                'Hozirda siz "Ikkinchi pastki" daraja darajasidasiz. Yurishda davom eting.';
        } else if (gpa >= 2.0) {
            style = "grey-text";
            greetingsText = "Hmmm...";
            eligibilityText =
                '"Umumiy daraja" siz uchun etarlimi? Qattiq mehnat qiling! Siz yaxshiroq qila olasiz.';
        } else {
            style = "red-text";
            greetingsText = "Kechirasiz!";
            eligibilityText = "Hozirda siz ilmiy darajaga ega emassiz.";
        }
